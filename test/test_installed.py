...
def test_plotly():
    assert isinstance(palettable.plotly.diverging.Picnic_3, Palette)
    assert isinstance(palettable.plotly.qualitative.Plotly_3, Palette)
    assert isinstance(palettable.plotly.sequential.Blackbody_3, Palette)
